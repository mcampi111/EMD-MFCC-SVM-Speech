...
ypred_syntspeak1_stat1<- predict(SVM_syntspeak1_stat1_van,newdata = x_IMF1)
...
ypred_syntspeak1_stat2<- predict(SVM_syntspeak1_stat2_van,newdata = x_IMF2)
...
ypred_syntspeak1_stat3<- predict(SVM_syntspeak1_stat3_van,newdata = x_IMF3)
...
ypred_syntspeak1_stat4<- predict(SVM_syntspeak1_stat4_van,newdata = x_IMF4)
...
ypred_syntspeak1_stat5<- predict(SVM_syntspeak1_stat5_van,newdata = x_IMF5)

...
ypred_syntspeak1_MLFC_IMF3_coeff1<- predict(SVM_syntspeak1_MLFC_IMF3_van[[1]],newdata = x_syntspeak1_MLFC_IMF3_new[,1:134])
...
ypred_syntspeak1_MLFC_IMF3_coeff2<- predict(SVM_syntspeak1_MLFC_IMF3_van[[2]],newdata = x_syntspeak1_MLFC_IMF3_new[,135:268])
...
ypred_syntspeak1_MLFC_IMF3_coeff3<- predict(SVM_syntspeak1_MLFC_IMF3_van[[3]],newdata = x_syntspeak1_MLFC_IMF3_new[,269:402])
...
ypred_syntspeak1_MLFC_IMF3_coeff4<- predict(SVM_syntspeak1_MLFC_IMF3_van[[4]],newdata = x_syntspeak1_MLFC_IMF3_new[,403:536])
...
ypred_syntspeak1_MLFC_IMF3_coeff5<- predict(SVM_syntspeak1_MLFC_IMF3_van[[5]],newdata = x_syntspeak1_MLFC_IMF3_new[,537:670])
...
ypred_syntspeak1_MLFC_IMF3_coeff6<- predict(SVM_syntspeak1_MLFC_IMF3_van[[6]],newdata = x_syntspeak1_MLFC_IMF3_new[,671:804])
...
ypred_syntspeak1_MLFC_IMF3_coeff7<- predict(SVM_syntspeak1_MLFC_IMF3_van[[7]],newdata = x_syntspeak1_MLFC_IMF3_new[,805:938])
...
ypred_syntspeak1_MLFC_IMF3_coeff8<- predict(SVM_syntspeak1_MLFC_IMF3_van[[8]],newdata = x_syntspeak1_MLFC_IMF3_new[,939:1072])
...
ypred_syntspeak1_MLFC_IMF3_coeff9<- predict(SVM_syntspeak1_MLFC_IMF3_van[[9]],newdata = x_syntspeak1_MLFC_IMF3_new[,1073:1206])
...
ypred_syntspeak1_MLFC_IMF3_coeff10<- predict(SVM_syntspeak1_MLFC_IMF3_van[[10]],newdata = x_syntspeak1_MLFC_IMF3_new[,1207:1340])
...
ypred_syntspeak1_MLFC_IMF3_coeff11<- predict(SVM_syntspeak1_MLFC_IMF3_van[[11]],newdata = x_syntspeak1_MLFC_IMF3_new[,1341:1474])
...
ypred_syntspeak1_MLFC_IMF3_coeff12<- predict(SVM_syntspeak1_MLFC_IMF3_van[[12]],newdata = x_syntspeak1_MLFC_IMF3_new[,1475:1608])
...
save(CM_syntspeak1_MLFC_IMF3_coeff1_new,CM_syntspeak1_MLFC_IMF3_coeff10_new,CM_syntspeak1_MLFC_IMF3_coeff11_new,
     ...
     file = "C:\\Users\\Marta\\Desktop\\Speech_OUT\\SVM_Speaker1_out\\VANN\\CM_speak1_CEP_IMF3_van.RData")

...
ypred_syntspeak1_SC1<- predict(SVM_syntspeak1_SC1_van,newdata = x_sc1)

CM_syntspeak1_SC1_new_van<- confusionMatrix(ypred_syntspeak1_SC1, yff)
CM_syntspeak1_SC1_new_van
...
ypred_syntspeak1_SC2<- predict(SVM_syntspeak1_SC2_van,newdata = x_sc2)

CM_syntspeak1_SC2_new_van<- confusionMatrix(ypred_syntspeak1_SC2, yff)
CM_syntspeak1_SC2_new_van
...
ypred_syntspeak1_SC3<- predict(SVM_syntspeak1_SC3_van,newdata = x_sc3)

CM_syntspeak1_SC3_new_van<- confusionMatrix(ypred_syntspeak1_SC3, yff)
CM_syntspeak1_SC3_new_van
...
ypred_syntspeak1_SC4<- predict(SVM_syntspeak1_SC4_van,x_sc4)

CM_syntspeak1_SC4_new_van<- confusionMatrix(ypred_syntspeak1_SC4, yff)
CM_syntspeak1_SC4_new_van
...
ypred_syntspeak1_SC5<- predict(SVM_syntspeak1_SC5_van,x_sc5)

CM_syntspeak1_SC5_new_van<- confusionMatrix(ypred_syntspeak1_SC5, yff)
CM_syntspeak1_SC5_new_van

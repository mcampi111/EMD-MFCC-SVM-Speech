...
ypred_syntspeak1_IMF1<- predict(SVM_syntspeak1_IMF1_van,newdata = x_syntspeak1_IMF_new[,1:60000])

CM_syntspeak1_IMF1_new_van<- confusionMatrix(ypred_syntspeak1_IMF1, yff)
CM_syntspeak1_IMF1_new_van
...
ypred_syntspeak1_IMF2<- predict(SVM_syntspeak1_IMF2_van,newdata = x_syntspeak1_IMF_new[,60001:120000])

CM_syntspeak1_IMF2_new_van<- confusionMatrix(ypred_syntspeak1_IMF2, yff)
CM_syntspeak1_IMF2_new_van
...
ypred_syntspeak1_IMF3<- predict(SVM_syntspeak1_IMF3_van,newdata = x_syntspeak1_IMF_new[,120001:180000])

CM_syntspeak1_IMF3_new_van<- confusionMatrix(ypred_syntspeak1_IMF3, yff)
CM_syntspeak1_IMF3_new_van
...
ypred_syntspeak1_IMF4<- predict(SVM_syntspeak1_IMF4_van,newdata = x_syntspeak1_IMF_new[,180001:240000])

CM_syntspeak1_IMF4_new_van<- confusionMatrix(ypred_syntspeak1_IMF4, yff)
CM_syntspeak1_IMF4_new_van
...
ypred_syntspeak1_IMF5<- predict(SVM_syntspeak1_IMF5_van,newdata = x_syntspeak1_IMF_new[,240001:300000])

CM_syntspeak1_IMF5_new_van<- confusionMatrix(ypred_syntspeak1_IMF5, yff)
CM_syntspeak1_IMF5_new_van

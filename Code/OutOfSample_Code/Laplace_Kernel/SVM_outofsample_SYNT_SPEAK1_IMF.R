...
xx1<- as.kernelMatrix(x1[,SVindex(SVM_syntspeak1_IMF1_lp)])

ypred_syntspeak1_IMF1_lp<- predict(SVM_syntspeak1_IMF1_lp,newdata = xx1)

CM_syntspeak1_IMF1_new_lp<- confusionMatrix(ypred_syntspeak1_IMF1_lp, yff)
CM_syntspeak1_IMF1_new_lp

predvec <- ifelse(ypred_syntspeak1_IMF1_lp=="uno", 1, 0)
...
xx2<- as.kernelMatrix(x2[,SVindex(SVM_syntspeak1_IMF2_lp)])

ypred_syntspeak1_IMF2_lp<- predict(SVM_syntspeak1_IMF2_lp, newdata = xx2)

CM_syntspeak1_IMF2_new_lp<- confusionMatrix(ypred_syntspeak1_IMF2_lp, yff)
CM_syntspeak1_IMF2_new_lp

predvec <- ifelse(ypred_syntspeak1_IMF2_lp=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
xx3<- as.kernelMatrix(x3[,SVindex(SVM_syntspeak1_IMF3_lp)])

ypred_syntspeak1_IMF3_lp<- predict(SVM_syntspeak1_IMF3_lp,newdata = xx3)

CM_syntspeak1_IMF3_new_lp<- confusionMatrix(ypred_syntspeak1_IMF3_lp, yff)
CM_syntspeak1_IMF3_new_lp

predvec <- ifelse(ypred_syntspeak1_IMF3_lp=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
xx4<- as.kernelMatrix(x4[,SVindex(SVM_syntspeak1_IMF4_lp)])


ypred_syntspeak1_IMF4_lp<- predict(SVM_syntspeak1_IMF4_lp,newdata = xx4)

CM_syntspeak1_IMF4_new_lp<- confusionMatrix(ypred_syntspeak1_IMF4_lp, yff)
CM_syntspeak1_IMF4_new_lp

predvec <- ifelse(ypred_syntspeak1_IMF4_lp=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
xx5<- as.kernelMatrix(x5[,SVindex(SVM_syntspeak1_IMF5_lp)])
ypred_syntspeak1_IMF5_lp<- predict(SVM_syntspeak1_IMF5_lp,newdata = xx5)

CM_syntspeak1_IMF5_new_lp<- confusionMatrix(ypred_syntspeak1_IMF5_lp, yff)
CM_syntspeak1_IMF5_new_lp


predvec <- ifelse(ypred_syntspeak1_IMF5_lp=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)

...
xx1<- as.kernelMatrix(x1[,SVindex(SVM_syntspeak1_SC1_lp)])

ypred_syntspeak1_SC1_lp<- predict(SVM_syntspeak1_SC1_lp,newdata = xx1)

CM_syntspeak1_SC1_new_lp<- confusionMatrix(ypred_syntspeak1_SC1_lp, yff)
CM_syntspeak1_SC1_new_lp

predvec <- ifelse(ypred_syntspeak1_SC1_lp=="uno", 1, 0)
...
xx2<- as.kernelMatrix(x2[,SVindex(SVM_syntspeak1_SC2_lp)])

ypred_syntspeak1_SC2_lp<- predict(SVM_syntspeak1_SC2_lp, newdata = xx2)

CM_syntspeak1_SC2_new_lp<- confusionMatrix(ypred_syntspeak1_SC2_lp, yff)
CM_syntspeak1_SC2_new_lp

predvec <- ifelse(ypred_syntspeak1_SC2_lp=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
xx3<- as.kernelMatrix(x3[,SVindex(SVM_syntspeak1_SC3_lp)])

ypred_syntspeak1_SC3_lp<- predict(SVM_syntspeak1_SC3_lp,newdata = xx3)

CM_syntspeak1_SC3_new_lp<- confusionMatrix(ypred_syntspeak1_SC3_lp, yff)
CM_syntspeak1_SC3_new_lp

predvec <- ifelse(ypred_syntspeak1_SC3_lp=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
xx4<- as.kernelMatrix(x4[,SVindex(SVM_syntspeak1_SC4_lp)])


ypred_syntspeak1_SC4_lp<- predict(SVM_syntspeak1_SC4_lp,newdata = xx4)

CM_syntspeak1_SC4_new_lp<- confusionMatrix(ypred_syntspeak1_SC4_lp, yff)
CM_syntspeak1_SC4_new_lp

predvec <- ifelse(ypred_syntspeak1_SC4_lp=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
xx5<- as.kernelMatrix(x5[,SVindex(SVM_syntspeak1_SC5_lp)])
ypred_syntspeak1_SC5_lp<- predict(SVM_syntspeak1_SC5_lp,newdata = xx5)

CM_syntspeak1_SC5_new_lp<- confusionMatrix(ypred_syntspeak1_SC5_lp, yff)
CM_syntspeak1_SC5_new_lp


predvec <- ifelse(ypred_syntspeak1_SC5_lp=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)

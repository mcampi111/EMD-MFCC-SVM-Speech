...
ypred_syntspeak1_MLFC_IMF2_coeff1<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[1]],newdata = x_syntspeak1_MLFC_IMF2_new[,1:134])
...
ypred_syntspeak1_MLFC_IMF2_coeff2<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[2]],newdata = x_syntspeak1_MLFC_IMF2_new[,135:268])
...
ypred_syntspeak1_MLFC_IMF2_coeff3<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[3]],newdata = x_syntspeak1_MLFC_IMF2_new[,269:402])
...
ypred_syntspeak1_MLFC_IMF2_coeff4<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[4]],newdata = x_syntspeak1_MLFC_IMF2_new[,403:536])
...
ypred_syntspeak1_MLFC_IMF2_coeff5<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[5]],newdata = x_syntspeak1_MLFC_IMF2_new[,537:670])
...
ypred_syntspeak1_MLFC_IMF2_coeff6<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[6]],newdata = x_syntspeak1_MLFC_IMF2_new[,671:804])
...
ypred_syntspeak1_MLFC_IMF2_coeff7<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[7]],newdata = x_syntspeak1_MLFC_IMF2_new[,805:938])
...
ypred_syntspeak1_MLFC_IMF2_coeff8<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[8]],newdata = x_syntspeak1_MLFC_IMF2_new[,939:1072])
...
ypred_syntspeak1_MLFC_IMF2_coeff9<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[9]],newdata = x_syntspeak1_MLFC_IMF2_new[,1073:1206])
...
ypred_syntspeak1_MLFC_IMF2_coeff10<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[10]],newdata = x_syntspeak1_MLFC_IMF2_new[,1207:1340])
...
ypred_syntspeak1_MLFC_IMF2_coeff11<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[11]],newdata = x_syntspeak1_MLFC_IMF2_new[,1341:1474])
...
ypred_syntspeak1_MLFC_IMF2_coeff12<- predict(SVM_syntspeak1_MLFC_IMF2_lp[[12]],newdata = x_syntspeak1_MLFC_IMF2_new[,1475:1608])
...
save(CM_syntspeak1_MLFC_IMF2_coeff1_new,CM_syntspeak1_MLFC_IMF2_coeff10_new,CM_syntspeak1_MLFC_IMF2_coeff11_new,
     ...
     file = "C:\\Users\\Marta\\Desktop\\Speech_OUT\\SVM_Speaker1_out\\LP\\CM_speak1_CEP_IMF2_LP.RData")

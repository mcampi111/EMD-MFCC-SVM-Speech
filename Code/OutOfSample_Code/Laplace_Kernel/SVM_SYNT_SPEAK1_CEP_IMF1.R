...
ypred_syntspeak1_MLFC_IMF1_coeff1<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[1]],newdata = x_syntspeak1_MLFC_IMF1_new[,1:134])
...
ypred_syntspeak1_MLFC_IMF1_coeff2<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[2]],newdata = x_syntspeak1_MLFC_IMF1_new[,135:268])
...
ypred_syntspeak1_MLFC_IMF1_coeff3<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[3]],newdata = x_syntspeak1_MLFC_IMF1_new[,269:402])
...
ypred_syntspeak1_MLFC_IMF1_coeff4<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[4]],newdata = x_syntspeak1_MLFC_IMF1_new[,403:536])
...
ypred_syntspeak1_MLFC_IMF1_coeff5<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[5]],newdata = x_syntspeak1_MLFC_IMF1_new[,537:670])
...
ypred_syntspeak1_MLFC_IMF1_coeff6<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[6]],newdata = x_syntspeak1_MLFC_IMF1_new[,671:804])
...
ypred_syntspeak1_MLFC_IMF1_coeff7<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[7]],newdata = x_syntspeak1_MLFC_IMF1_new[,805:938])
...
ypred_syntspeak1_MLFC_IMF1_coeff8<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[8]],newdata = x_syntspeak1_MLFC_IMF1_new[,939:1072])
...
ypred_syntspeak1_MLFC_IMF1_coeff9<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[9]],newdata = x_syntspeak1_MLFC_IMF1_new[,1073:1206])
...
ypred_syntspeak1_MLFC_IMF1_coeff10<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[10]],newdata = x_syntspeak1_MLFC_IMF1_new[,1207:1340])
...
ypred_syntspeak1_MLFC_IMF1_coeff11<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[11]],newdata = x_syntspeak1_MLFC_IMF1_new[,1341:1474])
...
ypred_syntspeak1_MLFC_IMF1_coeff12<- predict(SVM_syntspeak1_MLFC_IMF1_lp[[12]],newdata = x_syntspeak1_MLFC_IMF1_new[,1475:1608])
...
save(CM_syntspeak1_MLFC_IMF1_coeff1_new,CM_syntspeak1_MLFC_IMF1_coeff10_new,CM_syntspeak1_MLFC_IMF1_coeff11_new,
     ...
     file = "C:\\Users\\Marta\\Desktop\\Speech_OUT\\SVM_Speaker1_out\\LP\\CM_speak1_CEP_IMF1_LP.RData")

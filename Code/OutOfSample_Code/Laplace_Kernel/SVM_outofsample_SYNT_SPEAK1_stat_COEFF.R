...
ypred_syntspeak1_stat1<- predict(SVM_syntspeak1_stat1_lp,newdata = x_IMF1)
...
ypred_syntspeak1_stat2<- predict(SVM_syntspeak1_stat2_lp,newdata = x_IMF2)
...
ypred_syntspeak1_stat3<- predict(SVM_syntspeak1_stat3_lp,newdata = x_IMF3)
...
ypred_syntspeak1_stat4<- predict(SVM_syntspeak1_stat4_lp,newdata = x_IMF4)
...
ypred_syntspeak1_stat5<- predict(SVM_syntspeak1_stat5_lp,newdata = x_IMF5)

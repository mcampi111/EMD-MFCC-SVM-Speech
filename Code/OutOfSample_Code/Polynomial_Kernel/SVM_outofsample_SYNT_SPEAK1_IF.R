...
ypred_syntspeak1_IF1<- predict(SVM_syntspeak1_IF1_poly,newdata = x_syntspeak1_IF_new[,1:60000])

CM_syntspeak1_IF1_new_poly<- confusionMatrix(ypred_syntspeak1_IF1, yff)
CM_syntspeak1_IF1_new_poly
...
ypred_syntspeak1_IF2<- predict(SVM_syntspeak1_IF2_poly,newdata = x_syntspeak1_IF_new[,60001:120000])

CM_syntspeak1_IF2_new_poly<- confusionMatrix(ypred_syntspeak1_IF2, yff)
CM_syntspeak1_IF2_new_poly
...
ypred_syntspeak1_IF3<- predict(SVM_syntspeak1_IF3_poly,newdata = x_syntspeak1_IF_new[,120001:180000])

CM_syntspeak1_IF3_new_poly<- confusionMatrix(ypred_syntspeak1_IF3, yff)
CM_syntspeak1_IF3_new_poly
...
ypred_syntspeak1_IF4<- predict(SVM_syntspeak1_IF4_poly,newdata = x_syntspeak1_IF_new[,180001:240000])

CM_syntspeak1_IF4_new_poly<- confusionMatrix(ypred_syntspeak1_IF4, yff)
CM_syntspeak1_IF4_new_poly
...
ypred_syntspeak1_IF5<- predict(SVM_syntspeak1_IF5_poly,newdata = x_syntspeak1_IF_new[,240001:300000])

CM_syntspeak1_IF5_new_poly<- confusionMatrix(ypred_syntspeak1_IF5, yff)
CM_syntspeak1_IF5_new_poly

...
ypred_syntspeak1_stat1<- predict(SVM_syntspeak1_stat1_poly,newdata = x_syntspeak1_stat_new[,1:70])

CM_syntspeak1_stat1_new_poly<- confusionMatrix(ypred_syntspeak1_stat1, yff)
CM_syntspeak1_stat1_new_poly
...
ypred_syntspeak1_stat2<- predict(SVM_syntspeak1_stat2_poly,newdata = x_syntspeak1_stat_new[,71:140])

CM_syntspeak1_stat2_new_poly<- confusionMatrix(ypred_syntspeak1_stat2, yff)
CM_syntspeak1_stat2_new_poly
...
ypred_syntspeak1_stat3<- predict(SVM_syntspeak1_stat3_poly,newdata = x_syntspeak1_stat_new[,141:210])

CM_syntspeak1_stat3_new_poly<- confusionMatrix(ypred_syntspeak1_stat3, yff)
CM_syntspeak1_stat3_new_poly
...
ypred_syntspeak1_stat4<- predict(SVM_syntspeak1_stat4_poly,newdata = x_syntspeak1_stat_new[,211:280])

CM_syntspeak1_stat4_new_poly<- confusionMatrix(ypred_syntspeak1_stat4, yff)
CM_syntspeak1_stat4_new_poly
...
ypred_syntspeak1_stat5<- predict(SVM_syntspeak1_stat5_poly,newdata = x_syntspeak1_stat_new[,281:350])

CM_syntspeak1_stat5_new_poly<- confusionMatrix(ypred_syntspeak1_stat5, yff)
CM_syntspeak1_stat5_new_poly

...
ypred_syntspeak1_SC1<- predict(SVM_syntspeak1_SC1_poly,newdata = x_sc1)

CM_syntspeak1_SC1_new_poly<- confusionMatrix(ypred_syntspeak1_SC1, yff)
CM_syntspeak1_SC1_new_poly
...
ypred_syntspeak1_SC2<- predict(SVM_syntspeak1_SC2_poly,newdata = x_sc2)

CM_syntspeak1_SC2_new_poly<- confusionMatrix(ypred_syntspeak1_SC2, yff)
CM_syntspeak1_SC2_new_poly
...
ypred_syntspeak1_SC3<- predict(SVM_syntspeak1_SC3_poly,newdata = x_sc3)

CM_syntspeak1_SC3_new_poly<- confusionMatrix(ypred_syntspeak1_SC3, yff)
CM_syntspeak1_SC3_new_poly
...
ypred_syntspeak1_SC4<- predict(SVM_syntspeak1_SC4_poly,x_sc4)

CM_syntspeak1_SC4_new_poly<- confusionMatrix(ypred_syntspeak1_SC4, yff)
CM_syntspeak1_SC4_new_poly
...
ypred_syntspeak1_SC5<- predict(SVM_syntspeak1_SC5_poly,x_sc5)

CM_syntspeak1_SC5_new_poly<- confusionMatrix(ypred_syntspeak1_SC5, yff)
CM_syntspeak1_SC5_new_poly

...
ypred_syntspeak1_MLFC_IMF4_coeff1<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[1]],newdata = x_syntspeak1_MLFC_IMF4_new[,1:134])
...
ypred_syntspeak1_MLFC_IMF4_coeff2<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[2]],newdata = x_syntspeak1_MLFC_IMF4_new[,135:268])
...
ypred_syntspeak1_MLFC_IMF4_coeff3<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[3]],newdata = x_syntspeak1_MLFC_IMF4_new[,269:402])
...
ypred_syntspeak1_MLFC_IMF4_coeff4<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[4]],newdata = x_syntspeak1_MLFC_IMF4_new[,403:536])
...
ypred_syntspeak1_MLFC_IMF4_coeff5<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[5]],newdata = x_syntspeak1_MLFC_IMF4_new[,537:670])
...
ypred_syntspeak1_MLFC_IMF4_coeff6<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[6]],newdata = x_syntspeak1_MLFC_IMF4_new[,671:804])
...
ypred_syntspeak1_MLFC_IMF4_coeff7<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[7]],newdata = x_syntspeak1_MLFC_IMF4_new[,805:938])
...
ypred_syntspeak1_MLFC_IMF4_coeff8<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[8]],newdata = x_syntspeak1_MLFC_IMF4_new[,939:1072])
...
ypred_syntspeak1_MLFC_IMF4_coeff9<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[9]],newdata = x_syntspeak1_MLFC_IMF4_new[,1073:1206])
...
ypred_syntspeak1_MLFC_IMF4_coeff10<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[10]],newdata = x_syntspeak1_MLFC_IMF4_new[,1207:1340])
...
ypred_syntspeak1_MLFC_IMF4_coeff11<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[11]],newdata = x_syntspeak1_MLFC_IMF4_new[,1341:1474])
...
ypred_syntspeak1_MLFC_IMF4_coeff12<- predict(SVM_syntspeak1_MLFC_IMF4_bess[[12]],newdata = x_syntspeak1_MLFC_IMF4_new[,1475:1608])
...
save(CM_syntspeak1_MLFC_IMF4_coeff1_new,CM_syntspeak1_MLFC_IMF4_coeff10_new,CM_syntspeak1_MLFC_IMF4_coeff11_new,
     ...
     file = "C:\\Users\\Marta\\Desktop\\Speech_OUT\\SVM_Speaker1_out\\BESS\\CM_speak1_CEP_IMF4_bess.RData")

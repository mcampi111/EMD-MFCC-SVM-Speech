...
#IF - FIRST IMF
x1<- x_syntspeak1_IF_new[,1:60000]
xx1<- as.kernelMatrix(x1[,SVindex(SVM_syntspeak1_IF1_bess)])

ypred_syntspeak1_IF1_bess<- predict(SVM_syntspeak1_IF1_bess,newdata = xx1)

CM_syntspeak1_IF1_new_bess<- confusionMatrix(ypred_syntspeak1_IF1_bess, yff)
CM_syntspeak1_IF1_new_bess

predvec <- ifelse(ypred_syntspeak1_IF1_bess=="uno", 1, 0)
...
#IF - SECOND IMF
x2<- x_syntspeak1_IF_new[,60001:120000]
xx2<- as.kernelMatrix(x2[,SVindex(SVM_syntspeak1_IF2_bess)])

ypred_syntspeak1_IF2_bess<- predict(SVM_syntspeak1_IF2_bess, newdata = xx2)

CM_syntspeak1_IF2_new_bess<- confusionMatrix(ypred_syntspeak1_IF2_bess, yff)
CM_syntspeak1_IF2_new_bess

predvec <- ifelse(ypred_syntspeak1_IF2_bess=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
#IF - THIRD IMF
x3<- x_syntspeak1_IF_new[,120001:180000]
xx3<- as.kernelMatrix(x3[,SVindex(SVM_syntspeak1_IF3_bess)])

ypred_syntspeak1_IF3_bess<- predict(SVM_syntspeak1_IF3_bess,newdata = xx3)

CM_syntspeak1_IF3_new_bess<- confusionMatrix(ypred_syntspeak1_IF3_bess, yff)
CM_syntspeak1_IF3_new_bess

predvec <- ifelse(ypred_syntspeak1_IF3_bess=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
#IF - FOURTH IMF
x4<- x_syntspeak1_IF_new[,180001:240000]
xx4<- as.kernelMatrix(x4[,SVindex(SVM_syntspeak1_IF4_bess)])


ypred_syntspeak1_IF4_bess<- predict(SVM_syntspeak1_IF4_bess,newdata = xx4)

CM_syntspeak1_IF4_new_bess<- confusionMatrix(ypred_syntspeak1_IF4_bess, yff)
CM_syntspeak1_IF4_new_bess

predvec <- ifelse(ypred_syntspeak1_IF4_bess=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)
...
#IF - FIFTH IMF
x5<- x_syntspeak1_IF_new[,240001:300000]
xx5<- as.kernelMatrix(x5[,SVindex(SVM_syntspeak1_IF5_bess)])
ypred_syntspeak1_IF5_bess<- predict(SVM_syntspeak1_IF5_bess,newdata = xx5)

CM_syntspeak1_IF5_new_bess<- confusionMatrix(ypred_syntspeak1_IF5_bess, yff)
CM_syntspeak1_IF5_new_bess


predvec <- ifelse(ypred_syntspeak1_IF5_bess=="uno", 1, 0)
realvec <- ifelse(yff =="uno", 1, 0)

...
ypred_syntspeak1_stat1<- predict(SVM_syntspeak1_stat1_tan,newdata = x_syntspeak1_stat_new[,1:70])
...
ypred_syntspeak1_stat2<- predict(SVM_syntspeak1_stat2_tan,newdata = x_syntspeak1_stat_new[,71:140])
...
ypred_syntspeak1_stat3<- predict(SVM_syntspeak1_stat3_tan,newdata = x_syntspeak1_stat_new[,141:210])
...
ypred_syntspeak1_stat4<- predict(SVM_syntspeak1_stat4_tan,newdata = x_syntspeak1_stat_new[,211:280])
...
ypred_syntspeak1_stat5<- predict(SVM_syntspeak1_stat5_tan,newdata = x_syntspeak1_stat_new[,281:350])

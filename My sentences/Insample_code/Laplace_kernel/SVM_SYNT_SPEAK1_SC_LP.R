...
for (i in seq(6000, 180000, by=6000)) {
  ...
  svm<- train(y = yf, x = x_sc1[,(i-5999):i], trControl = train_control, method = lpSVM, 
...
SVM_syntspeak1_SC1_lp<- ksvm(x = xmat2, y = yf, kernel = "matrix", type = "C-svc")
SVM_syntspeak1_SC1_lp

CM_syntspeak1_SC1_lp<- confusionMatrix(SVM_syntspeak1_SC1_lp@fitted, yf )
CM_syntspeak1_SC1_lp
...
for (i in seq(6000, 180000, by=6000)) {
  ...
  svm<- train(y = yf, x = x_sc2[,(i-5999):i], trControl = train_control, method = lpSVM, 
              preProcess = c("center", "scale"), metric = 'ROC') 
...
SVM_syntspeak1_SC2_lp<- ksvm(x = xmat2, y = yf, kernel = "matrix", type = "C-svc")
SVM_syntspeak1_SC2_lp

CM_syntspeak1_SC2_lp<- confusionMatrix(SVM_syntspeak1_SC2_lp@fitted, yf )
CM_syntspeak1_SC2_lp
...
for (i in seq(6000, 180000, by=6000)) {
  ...
  svm<- train(y = yf, x = x_sc3[,(i-5999):i], trControl = train_control, method = lpSVM, 
              preProcess = c("center", "scale"), metric = 'ROC') 
...
SVM_syntspeak1_SC3_lp<- ksvm(x = xmat2, y = yf, kernel = "matrix", type = "C-svc")
SVM_syntspeak1_SC3_lp

CM_syntspeak1_SC3_lp<- confusionMatrix(SVM_syntspeak1_SC3_lp@fitted, yf )
CM_syntspeak1_SC3_lp
...
for (i in seq(6000, 180000, by=6000)) {
  ...
  svm<- train(y = yf, x = x_sc4[,(i-5999):i], trControl = train_control, method = lpSVM, 
              preProcess = c("center", "scale"), metric = 'ROC') 
...
SVM_syntspeak1_SC4_lp<- ksvm(x = xmat2, y = yf, kernel = "matrix", type = "C-svc")
SVM_syntspeak1_SC4_lp

CM_syntspeak1_SC4_lp<- confusionMatrix(SVM_syntspeak1_SC4_lp@fitted, yf )
CM_syntspeak1_SC4_lp
...
for (i in seq(6000, 180000, by=6000)) {
  ...
  svm<- train(y = yf, x = x_sc5[,(i-5999):i], trControl = train_control, method = lpSVM, 
              preProcess = c("center", "scale"), metric = 'ROC') 
...
SVM_syntspeak1_SC5_lp<- ksvm(x = xmat2, y = yf, kernel = "matrix", type = "C-svc")
SVM_syntspeak1_SC5_lp

CM_syntspeak1_SC5_lp<- confusionMatrix(SVM_syntspeak1_SC5_lp@fitted, yf )
CM_syntspeak1_SC5_lp
